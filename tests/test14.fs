...
s" Hello!" s" (123)" +STR s" (456)" STR+ .s CLEAR CR
s" HeLlO" DUP DUP ." Original string: " .s CR ." UPPERCASE: " UPPERSTR .s CR ." lowercase: " LOWERSTR .s CR
s" +..." DUP ." Stack " .s RANDOM 10 MOD 1 + DUP . ." times as a string, add a + at the end and print:" CR MULTSTR s" +" STR+ .s CR
s" \tfff  " DUP .s 9 . CR LSTRIPSTR DUP .s 10 . CR RSTRIPSTR .s 11 . CR
s" \tfff  " DUP .s 0 . CR STRIPSTR DUP .s 0 . CR
10 0 DO s" Ligne n° " I INTSTR STR+ .s CR LOOP
s" 10" STRINT 10 + . CR